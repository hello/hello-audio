...
/*
Sample code from: https://github.com/sammarshallou/ouaudioapplets/blob/master/src/uk/ac/open/audio/adpcm/ADPCMEncoder.java

Based on this paper: http://faculty.salina.k-state.edu/tim/vox/dialogic_adpcm.pdf
*/
